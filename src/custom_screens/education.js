            ...
            <Col lg={6}>
              ...
              <Form id="form" onSubmit={this.handleSubmit}>
                <Form.Group>
                  ...
                  <Form.Control type="text" name="education" value={this.state.email} onChange={this.handleChange} className="form-control" />
                </Form.Group>
                ...
                <Form.Group>
                  ...
                  <Button type="submit" className="btn btn-primary"> EDUCATION</Button>
                </Form.Group>
